...
const NAV: NavItem[] = [
  ...
  { to: '/users', label: 'Users', icon: <IconStudents />, roles: ['SUPER_ADMIN', 'ADMIN'] },
  { to: '/admin/invite', label: 'Invite User', icon: <IconPlus />, roles: ['SUPER_ADMIN', 'ADMIN'] },
  { to: '/admin/invitations', label: 'Invitations', icon: <IconAudit />, roles: ['SUPER_ADMIN', 'ADMIN'] },
